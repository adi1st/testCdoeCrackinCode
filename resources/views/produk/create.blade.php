...
@section('content')
    ...
    <div class="justify-between flex">
        <h1 class="text-2xl font-bold" id="title">Tambah Produk</h1>
    </div>
    ...
    <div class="mt-8">
        <form action="/produk" method="post">
            ...
            <label for="" class="form-control">
                ...
                <input name="nama" value="{{ old('nama') }}" type="text" placeholder="Masukkan nama produk"
            ...
            <label for="" class="form-control">
                ...
                <div
                    ...
                    Rp
                    <input name="harga" value="{{ old('harga') }}" type="text" placeholder="Masukkan harga produk"
                        class="grow" required />
                </div>
                @error('harga')
                    <div class="label">
            ...
            <label for="" class="form-control">
                ...
                <div
                    ...
                    Total
                    <input name="stok" value="{{ old('stok') }}" type="text" placeholder="Masukkan stok produk"
                        class="grow" required />
                </div>
                @error('stok')
                    <div class="label">
